...
let neoData = [
  { full_name: "Atira", a: 0.7, e: 0.3322, i: 25.62, height: 1.4, size: 0.06, velocity: 0.5, url: 'http://www.atira-opis.42web.io/'},
  { full_name: "'Aylo'chaxnim", a: 0.55, e: 0.177, i: -15.8, height: 0.4, size: 0.04, velocity: -1.4},
  { full_name: "TG45", a: 2.1, e: 0.37, i: 23.33, height: 0.6, size: 0.03, velocity: 1},
  { full_name: "XZ130", a: 0.6, e: 0.45, i: 2.95, height: 0.4, size: 0.02, velocity: 0.6,},
  { full_name: "Moon", a: 4, e: 0.1, i: 5.1, height: 0.9, size: 0.15, velocity: 0.3, url: 'http://www.info-ksiezyc.42web.io/'},
];
